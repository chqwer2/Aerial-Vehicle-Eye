...
class process_dataset(object):
    def __init__(self,
        path_to_video = '', frame_interval=1, frame_kept_per_second=1):

        self.path_to_video = path_to_video
        self.frame_kept_per_second = frame_kept_per_second
        self.videos_list = [path_to_video]
...
path_to_video = './fire_demo/forest2.avi'

D = process_dataset(path_to_video=path_to_video)
D.extractImage()
